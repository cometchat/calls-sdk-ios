...
This is a reference application showcasing the integration of [CometChat's iOS Calls SDK](https://www.cometchat.com/docs/sdk/ios/calling-overview) in a SwiftUI project. It demonstrates how to implement real-time voice and video calling features with ease.
...
For issues running the project or integrating with our UI Kits, consult our [documentation](https://www.cometchat.com/docs/sdk/ios/calling-overview) or create a [support ticket](https://help.cometchat.com/hc/en-us). You can also access real-time support via the [CometChat Dashboard](http://app.cometchat.com/).
