...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "CometChatProCalls",
            url: "https://library.cometchat.io/ios/v3.0/xcode14/CometChatProCalls_3_0_5.xcframework.zip",
            checksum: "7fd7ec812acc9164396a1ee63f08cc954c227a47b04091a22fbb2e48f4ad13e8"
        ),
        .binaryTarget(
            name: "WebRTC",
