...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "CometChatCallsSDK",
            url: "https://library.cometchat.io/ios/v4.0/xcode15/CometChatCallsSDK_4_1_1-beta.1.xcframework.zip",
            checksum: "2c1ff513277acf84edb412eba14192a43ad6a0ebf10b1edc9edd0eabc41010ff"
        ),
        .binaryTarget(
            name: "WebRTC",
