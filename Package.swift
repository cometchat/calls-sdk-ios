...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "CometChatCallsSDK",
            url: "https://library.cometchat.io/ios/v4.0/xcode15/CometChatCallsSDK_4_1_1.xcframework.zip",
            checksum: "bc66ec826b9621bae53ff2552e1072176e8c855e4b8ed369c88d10871d851b17"
        ),
        .binaryTarget(
            name: "WebRTC",
