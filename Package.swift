...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "CometChatCallsSDK",
            url: "https://library.cometchat.io/ios/v4.0/xcode15/CometChatCallsSDK_4_0_8.xcframework.zip",
            checksum: "2b5daf3c38d25b1b57026b30541842318aa15c265f959c8af209ecce29039a38"
        ),
        .binaryTarget(
            name: "WebRTC",
