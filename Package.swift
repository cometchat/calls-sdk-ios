...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "CometChatProCalls",
            url: "https://library.cometchat.io/ios/spm/Calls/CometChatProCalls_3_0_0-alpha2.xcframework.zip",
            checksum: "28c955f247c6317ba276494ff41deaa0566e78cb946f6e4d5b696f0b09024265"
        ),
        .binaryTarget(
            name: "WebRTC",
